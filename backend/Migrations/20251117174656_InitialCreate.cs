        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NormalizedName = table.Column<string>(type: "nvarchar(450)", nullable: false, computedColumnSql: "UPPER([Name]) PERSISTED")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NormalizedTitle = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false, computedColumnSql: "UPPER([Title]) PERSISTED"),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    RowVersion = table.Column<byte[]>(type: "rowversion", rowVersion: true, nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Weight = table.Column<double>(type: "float(8)", precision: 8, scale: 2, nullable: false),
                    Calories = table.Column<double>(type: "float(8)", precision: 8, scale: 2, nullable: false),
                    CookingMethod = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
